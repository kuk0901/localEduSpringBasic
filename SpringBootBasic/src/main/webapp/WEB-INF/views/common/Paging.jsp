...
<nav>
	<ul>
		...
		<c:if test="${pagingMap.pagingVo.prevBlock ne 1}">
			<li><a href="#"
				onclick="goPage(${pagingMap.pagingVo.prevBlock});"> <span>≪</span>
			</a></li>
		</c:if>
		...
		<c:if
			test="${pagingMap.pagingVo.curBlock lt pagingMap.pagingVo.totBlock}">
			<li><a href="#"
				onclick="goPage(${pagingMap.pagingVo.nextBlock});"> <span>≫</span>
			</a></li>
		</c:if>
